package com.portalsoup.example.fullstack.core
 ...
 */
data class AppConfig(val hostname: String, val server: Server, val db: Db)
...
object Config {
    ...
    private fun getConfig(): AppConfig {
        ...
        return gson.fromJson(config, AppConfig::class.java)
            ?: throw RuntimeException("Failed to deserialize config file!")
    }
}
