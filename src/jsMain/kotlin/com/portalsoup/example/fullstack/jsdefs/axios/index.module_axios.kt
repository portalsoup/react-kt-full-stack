...
external interface AxiosInstance {
    ...
    fun <R> get(url: String, config: AxiosRequestConfig = definedExternally): Promise<R>
    ...
    fun <R> patch(url: String, data: Any = definedExternally, config: AxiosRequestConfig = definedExternally): Promise<R>
}
